<?php class Dbconnexion
{
    ...
    private const  HOST = 'mysql-je-test-des-truc.alwaysdata.net'; // hôte Alwaysdata
    private const  USER = '436440';
    private const  PASS = 'BonjourSurMonSite2025/';
    private const  BASE = 'je-test-des-truc_sql';
