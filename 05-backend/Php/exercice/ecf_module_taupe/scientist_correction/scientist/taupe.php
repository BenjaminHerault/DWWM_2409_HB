...
session_start();
if (!isset($_SESSION['level_scientist'])) {
    echo "Accès refusé";
    exit;
}
...
<body>
<?php
// echo "<pre>".var_export($scientist)."</pre>"; 
...
?>
 ...
 <div class="card">
        <p>
        <?php echo "M(e) ".$_SESSION["lastname_scientist"]. " ".$_SESSION["firstname_scientist"] ."<br>";  ?>    
...
<?php  if ($_SESSION['level_scientist']==2) {
    # code...
  ?>
        <div class="card">
