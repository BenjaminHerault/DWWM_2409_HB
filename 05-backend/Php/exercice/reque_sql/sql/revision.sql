...
-- Crée la table departements en premier
CREATE TABLE IF NOT EXISTS departements (
  id_dep INT(10) UNSIGNED NOT NULL PRIMARY KEY,
...
-- Ensuite, crée la table personnage
CREATE TABLE IF NOT EXISTS personnage (
  id INT AUTO_INCREMENT PRIMARY KEY,
  nom VARCHAR(100) NOT NULL,
  prenom VARCHAR(100) NOT NULL,
  id_departement_naissance INT UNSIGNED NOT NULL,
  FOREIGN KEY (id_departement_naissance) REFERENCES departements(id_dep)
);
...
INSERT INTO `departements` (`id_dep`, `dep_nom`, `dep_actif`, `dep_taux`) VALUES
(1, '01 - Ain', 1, 1.00),
(2, '02 - Aisne', 1, 1.00),
(3, '03 - Allier', 1, 1.00),
